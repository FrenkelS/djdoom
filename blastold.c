...
static char *BLASTER_ErrorString
   (
   int ErrorNumber
   )
   ...
   switch( ErrorNumber )
      ...
      case BLASTER_AddrNotSet :
         ErrorString = "Missing Sound Blaster address in BLASTER environment variable.";
         break;

      case BLASTER_IntNotSet :
         ErrorString = "Missing Sound Blaster interrupt in BLASTER environment variable.";
         break;

      case BLASTER_DMANotSet :
         ErrorString = "Missing Sound Blaster DMA channel in BLASTER environment variable.";
         break;

      case BLASTER_DMA16NotSet :
         ErrorString = "Missing Sound Blaster 16-bit DMA channel in BLASTER environment variable.";
         break;

      case BLASTER_MIDINotSet :
         ErrorString = "Missing WaveBlaster MIDI port in BLASTER environment variable.";
         break;

      case BLASTER_CardTypeNotSet :
         ErrorString = "Missing Sound Blaster card Type parameter in BLASTER environment variable.";
         break;
...
static unsigned BLASTER_GetPlaybackRate
   (
   void
   )
...
static void BLASTER_StopPlayback
   (
   void
   )
...
static int BLASTER_GetCurrentPos
   (
   void
   )
...
static int BLASTER_BeginBufferedPlayback
   (
   char    *BufferStart,
   int      BufferSize,
   int      NumDivisions,
...
static int BLASTER_DSP4xx_BeginRecord
   (
   int length
   )
...
static int BLASTER_DSP2xx_BeginRecord
   (
   int length
   )
...
static int BLASTER_BeginBufferedRecord
   (
   char    *BufferStart,
   int      BufferSize,
   int      NumDivisions,
...
static int BLASTER_GetVoiceVolume
   (
   void
   )
...
static int BLASTER_SetVoiceVolume
   (
   int volume
   )
...
static int BLASTER_SetCardSettings
   (
   BLASTER_CONFIG Config
   )
...
static int BLASTER_GetCardSettings
   (
   BLASTER_CONFIG *Config
   )
...
static int BLASTER_GetCardInfo
   (
   int *MaxSampleBits,
   int *MaxChannels
   )
